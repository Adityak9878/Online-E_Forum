...
<body>
    ...
    <?php 
        ...
        if($method=='POST')
        {
            ...
            $td_desc=$_POST['title_desc'];
            $sql="INSERT INTO `threads` (`thread_name`, `thread_disc`, `thread_cat_id`, `thread_user_id`, `timestamp`) 
            VALUES ('$td_title', '$td_desc', '$id', '0', current_timestamp())";
    ...
    <div class="container my-3">
        <div class="jumbotron">
            ...
            <hr class="my-4">
            <p>For Redirecting to Wikipedia Please Click To Learn More.</p>
            <a class="btn btn-success btn-lg" href="https://en.wikipedia.org/wiki/Python_(programming_language)"
    ...
    echo '<div class="container">
        <form action="'.$_SERVER["REQUEST_URI"].'" method="POST">
            <div class="form-group">
                ...
                <small id="title" class="form-text text-muted">Well never share your email with anyone
                    else.</small>
            </div>
            <div class="form-group">
                <label for="exampleFormControlTextarea1">Elaborate Your Questions</label>
                <textarea class="form-control" name="title_desc" id="title_desc" rows="3"></textarea>
            </div>
...
?>
    ...
    <div class="container my-4">
        <div class="media my-3">
            ...
            <div class="media-body my-0 mx-0">
            <p class="font-weight-bold my-0">Anonymus User at '.$td_time.' </p>
                <h5 class="mt-0"><a href="thread.php?threadid='.$threadid.'" class="text-dark">'.$threadname.'</a></h5>
                <p>'.$threaddisc.' </p>';
